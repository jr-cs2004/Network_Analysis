...
for i in range(0, n):
    if (DIP_to_STRING_IDs[1][i].split('.')[0] == '511145'):
        counter += 1
...
DEG_File = open("F:\\Courses\\Graph perturbation\\Data\\DEG raw data\\Downloaded on 11 25 2019\\E. Coli K12\\Escherichia coli K12_all.txt", "r") 
DEG_IDs = []
DEG_Essentiality = []
